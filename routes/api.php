...
use App\Http\Controllers\ClientSideControllers\ProductDetails_Payment\{AddCartController,DelCartController,GetCartProducts,GetSuggestedProducts,GetProductDetails};
